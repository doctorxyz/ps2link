...
pkoReset(void)
{
    ...
    SifExitRpc();
	GS_BGCOLOUR = 0xFFFF00;	//Cyan / Aqua
    while(SifIopSync());

	GS_BGCOLOUR = 0xFF00FF;	//Magenta / Fuchsia
    SifInitRpc(0);

	GS_BGCOLOUR = 0xC0C0C0;	//Silver
	cdvdExit();

	GS_BGCOLOUR = 0x808080;	//Gray
    SifExitRpc();

	GS_BGCOLOUR = 0x000080;	//Maroon
    FlushCache(0);

	GS_BGCOLOUR = 0x008080;	//Olive
